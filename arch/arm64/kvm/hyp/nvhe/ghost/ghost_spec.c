...
{
	// TODO: SVE and SME config. see kvm_emulate.h::kvm_get_reset_cptr_el2()
...
static bool compute_new_abstract_state_handle___pkvm_init_vm(struct ghost_state *g1, struct ghost_state *g0, struct ghost_call_data *call) {
	...
	vm1->protected = GHOST_READ_ONCE(call, host_kvm->arch.pkvm.is_protected);
...
static bool compute_new_abstract_state_handle___pkvm_teardown_vm(struct ghost_state *g1, struct ghost_state *g0, struct ghost_call_data *call)
{
	...
	// can't tear down VM,
	// so return -EBUSY
	for (int i=0; i<vm->vm_table_locked.nr_initialised_vcpus; i++) {
...
static struct ghost_trap_data host_hcalls[] = {
	...
	HOST_HCALL(__pkvm_iommu_register_ops, "", "ops: %p", "", "", "", ""),
	HOST_HCALL(__pkvm_devices_init, "", "", "", "", "", ""),
	...
	HOST_HCALL(__pkvm_host_donate_guest_sglist, "", "", "", "", "", ""),
	HOST_HCALL(__pkvm_host_unshare_guest, "", "handle: %x", "gfn: %llx", "nr_pages: %llu", "", ""),
	HOST_HCALL(__pkvm_host_relax_perms_guest, "", "gfn:%llx", "prot: %lx", "", "", ""),
	HOST_HCALL(__pkvm_host_wrprotect_guest, "", "handle: %x", "gfn: %llx", "nr_pages: %llu", "", ""),
	HOST_HCALL(__pkvm_host_test_clear_young_guest, "", "handle: %x", "gfn: %llx", "nr_pages: %llu", "mkold: %d", ""),
	HOST_HCALL(__pkvm_host_mkyoung_guest, "", "gfn:%llx", "", "", "", ""),
	HOST_HCALL(__pkvm_host_split_guest, "", "gfn:%llx", "size: %llu", "", "", ""),
	...
	HOST_HCALL(__pkvm_reserve_vm, "", "", "", "", "", ""),
	HOST_HCALL(__pkvm_unreserve_vm, "", "handle: %x", "", "", "", ""),
	HOST_HCALL(__pkvm_init_vm, "", "host_kvm: %p", "pgd_hva: %lx", "", "", ""),
	HOST_HCALL(__pkvm_init_vcpu, "", "handle: %x", "host_vcpu: %p", "", "", ""),
	HOST_HCALL(__pkvm_reclaim_dying_guest_page, "", "handle: %x", "gfn: %llx", "nr_pages: %llu", "", ""),
	HOST_HCALL(__pkvm_start_teardown_vm, "", "handle: %x", "", "", "", ""),
	HOST_HCALL(__pkvm_finalize_teardown_vm, "", "handle: %x", "", "", "", ""),
	HOST_HCALL(__pkvm_reclaim_dying_guest_ffa_resources, "", "handle: %x", "", "", "", ""),
	HOST_HCALL(__pkvm_notify_guest_vm_avail, "", "handle: %x", "", "", "", ""),
	...
	HOST_HCALL(__pkvm_update_clock_tracing, "", "mult: %x", "shift: %x", "epoch_ns: %lx", "epoch_cyc: %lx", ""),
	...
	HOST_HCALL(__pkvm_reset_tracing, "", "cpu: %u", "", "", "", ""),
	HOST_HCALL(__pkvm_swap_reader_tracing, "", "cpu: %u", "", "", "", ""),
	HOST_HCALL(__pkvm_enable_event, "", "id: %u", "enable: %u", "", "", ""),
	HOST_HCALL(__pkvm_selftest_event, "", "", "", "", "", ""),
	HOST_HCALL(__pkvm_sync_ftrace, "", "host_func_pg: %lu", "", "", "", ""),
	HOST_HCALL(__pkvm_disable_ftrace, "", "", "", "", "", ""),
	HOST_HCALL(__pkvm_hyp_alloc_mgt_refill, "", "id: %lu", "phys: %llx", "nr_pages: %lu", "", ""),
	HOST_HCALL(__pkvm_hyp_alloc_mgt_reclaimable, "", "", "", "", "", ""),
	HOST_HCALL(__pkvm_hyp_alloc_mgt_reclaim, "", "id: %d", "target: %d", "", "", ""),
	HOST_HCALL(__pkvm_ptdump, "", "handle: %u", "op: %u", "log: %p", "", ""),
	HOST_HCALL(__pkvm_host_get_ffa_version, "", "", "", "", "", ""),
	HOST_HCALL(__pkvm_host_iommu_alloc_domain, "", "drv_id: %u", "iommu_id: %u", "domain: %u", "", ""),
	HOST_HCALL(__pkvm_host_iommu_free_domain, "", "domain: %x", "", "", "", ""),
	HOST_HCALL(__pkvm_host_iommu_attach_dev, "", "iommu: %x", "domain: %x", "endpoint: %u", "pasid: %u", "pasid_bits: %u"), // TODO(porting): flags %lu in X6 (prot)
	HOST_HCALL(__pkvm_host_iommu_attach_dev_nested, "", "iommu: %x", "domain: %x", "endpoint: %u", "pasid: %u", "flags: %lu"), // TODO(porting): s1_desc_have: %p in X6, s1_desc_size: %lu in X7
	HOST_HCALL(__pkvm_host_iommu_detach_dev, "", "iommu: %x", "domain: %x", "endpoint: %u", "pasid: %u", ""),
	HOST_HCALL(__pkvm_host_iommu_iotlb_inv_nested_domain, "", "domain: %x", "iova: %lu", "size: %lu", "granule: %lu", "leaf: %d"),
	HOST_HCALL(__pkvm_host_iommu_nested_cfg_sync, "", "drv_id: %x", "iommu: %x", "cmd_desc_hva: %p", "cmd_desc_size: %lu", ""),
	...
	HOST_HCALL(__pkvm_host_iommu_set_identity, "", "drv_id: %u", "iommu: %u", "dev: %u", "on: %u", ""),
	HOST_HCALL(__pkvm_host_iommu_map_sg, "", "domain: %u", "iova: %lu", "sg: %p", "nent: %u", "prot: %u"),
	HOST_HCALL(__pkvm_host_hvc_pd, "", "device_id: %llx", "on: %llx", "", "", ""),
	HOST_HCALL(__pkvm_host_iommu_iotlb_sync_map, "", "domain: %u", "iova: %lu", "size: %lu", "", ""),
	HOST_HCALL(__pkvm_host_donate_hyp_mmio, "", "pfn: %llx", "nr_pages: %llu", "", "", ""),
	HOST_HCALL(__pkvm_host_reclaim_hyp_mmio, "", "pfn: %llx", "nr_pages: %llu", "", "", ""),
	HOST_HCALL(__pkvm_host_map_guest_mmio, "", "pfn: %llx", "gfn: %llx", "", "", ""),
	HOST_HCALL(__pkvm_pviommu_attach, "", "host_kvm: %p", "pviommu: %d", "", "", ""),
	HOST_HCALL(__pkvm_pviommu_add_vsid, "", "hst_kvm: %p", "pviommu: %u", "iommu: %u", "sid: %u", "vsid: %u"),
};
