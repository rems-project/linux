...
static void vm_table_lock_component(void)
{
	...
	ghost_simplified_model_step_lock(GHOST_SIMPLIFIED_LOCK, hyp_virt_to_phys(&vm_table_lock));
...
#ifdef CONFIG_NVHE_GHOST_SIMPLIFIED_MODEL
	ghost_simplified_model_step_lock(GHOST_SIMPLIFIED_UNLOCK, hyp_virt_to_phys(&vm_table_lock));
#endif /* CONFIG_NVHE_GHOST_SIMPLIFIED_MODEL */
