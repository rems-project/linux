...
static const char *ghost_host_hcall_names[] = {
	...
	HANDLE_FUNC_STRING(__pkvm_iommu_init),
	...
	HANDLE_FUNC_STRING(__pkvm_host_unmap_guest),
	HANDLE_FUNC_STRING(__pkvm_relax_perms),
	HANDLE_FUNC_STRING(__pkvm_wrprotect),
	HANDLE_FUNC_STRING(__pkvm_dirty_log),
	...
	HANDLE_FUNC_STRING(__pkvm_stage2_snapshot),
};
