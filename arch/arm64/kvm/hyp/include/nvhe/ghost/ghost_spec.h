...
static const char *ghost_host_hcall_names[] = {
	...
	HANDLE_FUNC_STRING(__kvm_tlb_flush_vmid_ipa_nsh),
	HANDLE_FUNC_STRING(__kvm_tlb_flush_vmid),
	HANDLE_FUNC_STRING(__kvm_tlb_flush_vmid_range),
	...
	HANDLE_FUNC_STRING(__pkvm_iommu_register_ops),
	HANDLE_FUNC_STRING(__pkvm_devices_init),
	...
	HANDLE_FUNC_STRING(__pkvm_host_donate_guest_sglist),
	HANDLE_FUNC_STRING(__pkvm_host_unshare_guest),
	HANDLE_FUNC_STRING(__pkvm_host_relax_perms_guest),
	HANDLE_FUNC_STRING(__pkvm_host_wrprotect_guest),
	HANDLE_FUNC_STRING(__pkvm_host_test_clear_young_guest),
	HANDLE_FUNC_STRING(__pkvm_host_mkyoung_guest),
	HANDLE_FUNC_STRING(__pkvm_host_split_guest),
	...
	HANDLE_FUNC_STRING(__pkvm_reserve_vm),
	HANDLE_FUNC_STRING(__pkvm_unreserve_vm),
	HANDLE_FUNC_STRING(__pkvm_init_vm),
	HANDLE_FUNC_STRING(__pkvm_init_vcpu),
	HANDLE_FUNC_STRING(__pkvm_reclaim_dying_guest_page),
	HANDLE_FUNC_STRING(__pkvm_start_teardown_vm),
	HANDLE_FUNC_STRING(__pkvm_finalize_teardown_vm),
	HANDLE_FUNC_STRING(__pkvm_reclaim_dying_guest_ffa_resources),
	HANDLE_FUNC_STRING(__pkvm_notify_guest_vm_avail),
	HANDLE_FUNC_STRING(__pkvm_vcpu_load),
	HANDLE_FUNC_STRING(__pkvm_vcpu_put),
	HANDLE_FUNC_STRING(__pkvm_vcpu_sync_state),
	HANDLE_FUNC_STRING(__pkvm_tlb_flush_vmid),
	HANDLE_FUNC_STRING(__pkvm_update_clock_tracing),
	HANDLE_FUNC_STRING(__pkvm_load_tracing),
	HANDLE_FUNC_STRING(__pkvm_teardown_tracing),
	HANDLE_FUNC_STRING(__pkvm_enable_tracing),
	HANDLE_FUNC_STRING(__pkvm_reset_tracing),
	HANDLE_FUNC_STRING(__pkvm_swap_reader_tracing),
	HANDLE_FUNC_STRING(__pkvm_enable_event),
	HANDLE_FUNC_STRING(__pkvm_selftest_event),
	HANDLE_FUNC_STRING(__pkvm_sync_ftrace),
	HANDLE_FUNC_STRING(__pkvm_disable_ftrace),
	HANDLE_FUNC_STRING(__pkvm_hyp_alloc_mgt_refill),
	HANDLE_FUNC_STRING(__pkvm_hyp_alloc_mgt_reclaimable),
	HANDLE_FUNC_STRING(__pkvm_hyp_alloc_mgt_reclaim),
	HANDLE_FUNC_STRING(__pkvm_ptdump),
	HANDLE_FUNC_STRING(__pkvm_host_get_ffa_version),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_alloc_domain),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_free_domain),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_attach_dev),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_detach_dev),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_map_pages),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_unmap_pages),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_iova_to_phys),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_set_identity),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_map_sg),
	HANDLE_FUNC_STRING(__pkvm_host_hvc_pd),
	HANDLE_FUNC_STRING(__pkvm_host_iommu_iotlb_sync_map),
	HANDLE_FUNC_STRING(__pkvm_host_donate_hyp_mmio),
	HANDLE_FUNC_STRING(__pkvm_host_reclaim_hyp_mmio),
	HANDLE_FUNC_STRING(__pkvm_host_map_guest_mmio),
	HANDLE_FUNC_STRING(__pkvm_pviommu_attach),
	HANDLE_FUNC_STRING(__pkvm_pviommu_add_vsid),
};
