#ifndef __ARM64_KVM_HYP_GHOST_SERIAL_H__
#define __ARM64_KVM_HYP_GHOST_SERIAL_H__

#include <linux/types.h>

// gives us hyp_putc(), hyp_puts(), hyp_putx64()
...
#endif /* __ARM64_KVM_HYP_GHOST_SERIAL_H__ */
